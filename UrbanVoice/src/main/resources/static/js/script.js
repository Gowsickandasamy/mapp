...
function confirmEditJury(event) {
	...
	confirmBtn.textContent = 'Yes';
	confirmBtn.addEventListener('click', function() {
		window.location.href = "/urbanvoice/admin/jurisdictions/edit-jury?id=" + juryId;
...
function confirmDeleteJury(event) {
	...
	confirmBtn.textContent = 'Yes';
	confirmBtn.addEventListener('click', function() {
		window.location.href = "/urbanvoice/admin/jurisdictions/delete-jury?id=" + juryId;
		dialogContainer.remove();
	});
...
function confirmEditOfficer(event) {
	...
	confirmBtn.textContent = 'Yes';
	confirmBtn.addEventListener('click', function() {
		window.location.href = "/urbanvoice/admin/officers/edit-officer?id=" + officerId;
		dialogContainer.remove();
	});
...
function confirmDeleteOfficer(event) {
	...
	confirmBtn.textContent = 'Yes';
	confirmBtn.addEventListener('click', function() {
		window.location.href = "/urbanvoice/admin/officers/delete-officer?id=" + officerId;
		dialogContainer.remove();
	});
...
function updateWards() {
	...
	$.ajax({
		type: "GET",
		url: "/urbanvoice/user/wards?area=" + encodeURIComponent(selectedArea),
...
function updateLayouts() {
	...
	$.ajax({
		type: "GET",
		url: "/urbanvoice/user/layouts?ward=" + encodeURIComponent(selectedWard),
