...
import com.team2.urbanvoice.models.PasswordModel;
import com.team2.urbanvoice.service.AdminService;
import com.team2.urbanvoice.service.ComplaintService;
import com.team2.urbanvoice.service.JurisdictionService;
...
@Controller
@RequestMapping("/urbanvoice/admin")
public class AdminController {
	...
	private static final String REDIRECT_ADMIN_JURISDICTION_PAGE_VIEW = "redirect:/urbanvoice/admin/jurisdictions";
	private static final String REDIRECT_ADMIN_OFFICER_PAGE_VIEW = "redirect:/urbanvoice/admin/officers";
	...
	private static final String REDIRECT_ADMIN_EDIT_OFFICER_PAGE_VIEW_WITH_ID = "redirect:/urbanvoice/admin/officers/edit-officer?id=";
	private static final String REDIRECT_ADMIN_EDIT_JURY_PAGE_VIEW_WITH_ID = "redirect:/urbanvoice/admin/jurisdictions/edit-jury?id=";
	private static final String REDIRECT_LOGIN_LOGOUT = "redirect:/urbanvoice/login?logout";
	private static final String REDIRECT_ADMIN_VIEW_PROFILE_PAGE_VIEW = "redirect:/urbanvoice/admin/view-profile";
	...
	public String updateStatus(@PathVariable int complaintId, @RequestParam Status newStatus, RedirectAttributes redirectAttributes, User user) throws Exception {
		...
		return "redirect:/urbanvoice/admin/track-complaints";
	}
}