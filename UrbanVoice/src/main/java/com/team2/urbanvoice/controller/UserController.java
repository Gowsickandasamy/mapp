...
@Controller
@RequestMapping("/urbanvoice/user")
public class UserController {
	private static final String REDIRECT_USER_HOME_PAGE_VIEW = "redirect:/urbanvoice/user/track-complaints";
	...
	private static final String REDIRECT_USER_EDIT_PAGE_VIEW_WITH_ID = "redirect:/urbanvoice/user/edit-profile?id=";
  private static final String SUCCESS_MESSAGE = "successMessage";
	private static final String REDIRECT_USER_VIEW_PROFILE_PAGE_VIEW = "redirect:/urbanvoice/user/view-profile";
