...
public class OfficerServiceImpl implements OfficerService {
	...
	@Override
	public Officer createOfficer(OfficerModel officerCreateModel, Jurisdiction jury) throws Exception, UrbanVoiceException{
		...
		if(Objects.isNull(officerByPhone) && Objects.isNull(officerByEmail)) {
			...
			String firstThreeLetters = officerCreateModel.getOfficerName().substring(0, 4);
			...
			throw new UrbanVoiceException("Officer with Email Id or Phone No. already Exists !");
		}
	}
